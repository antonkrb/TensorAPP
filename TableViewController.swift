                ...
                if let context = (UIApplication.shared.delegate as? AppDelegate)?.coreDataStack.persistentContainer.viewContext{
                    ...
                    for element in json {
                      ...
                      //  for subs in msubs {
                        ...
                        folders.subs_title = msubs as NSObject?
                        //print(msubs)
...
//     //   self.mTitle.remove(at: indexPath.row)
//       self.fetchResultsController.object(at: IndexPath.row)
//        
//        
//        tableView.deleteRows(at: [indexPath], with: .fade)
//        if let context = (UIApplication.shared.delegate as? AppDelegate)?.coreDataStack.persistentContainer.viewContext{
...
//        }
        ...
        let managedObject = self.fetchResultsController.object(at: indexPath) as NSManagedObject
        self.fetchResultsController.managedObjectContext.delete(managedObject)
        
        do {
            try self.fetchResultsController.managedObjectContext.save()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "subs"{
            if let IndexPath = tableView.indexPathForSelectedRow{
               ...
               // dvc.folders = (self.fetchResultsController.fetchedObjects?[IndexPath.row])
                dvc.pFolder.removeAll()
                dvc.htitle = (self.fetchResultsController.fetchedObjects?[IndexPath.row].folder_title)!
               let mArray = self.fetchResultsController.fetchedObjects?[IndexPath.row].subs_title
               dvc.SubsObject = mArray!
//               for element in mArray as! NSArray{
//                let element = element as! [String: Any]
////                    dvc.pFolder.append(element as! String)
//                //print(element["title"])
//               
//                dvc.pFolder.append(element["title"] as! String)
//    
//                }
                
//                dvc.pFolder.append((self.fetchResultsController.fetchedObjects?[IndexPath.row].subs_title! as! NSString) as String)
